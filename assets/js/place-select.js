jQuery( function($) {
  ...
  // Update css
  $().ready(function() {
    // $("#billing_first_name_field").css({'width': '36%', 'margin-right': '4%'});
    // $("#billing_last_name_field").css({'width': '60%'});    
    $("#billing_country_field").css({'display': 'none'}); // Default is VN so make it disable

    // $("#shipping_first_name_field").css({'width': '36%', 'margin-right': '4%'});
    // $("#shipping_last_name_field").css({'width': '60%'});    
    $("#shipping_country_field").css({'display': 'none'}); // Default is VN so make it disable
  });
});
